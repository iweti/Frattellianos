    ...
    <>
      ...
      <main className="overflow-hidden">
        ...
        >
          ...
          <figure className="relative m-0 flex aspect-5/3 items-center justify-center overflow-hidden border border-brand- bg-[radial-gradient(circle_at_center,rgba(227,49,44,0.18),transparent_62%),#090b0b] p-6 before:absolute before:-z-10 before:inset-[15%_-8%_-8%_20%] before:bg-brand-red before:opacity-[0.18] before:blur-[70px] before:content-[''] max-[900px]:max-w-170">
            <img
              className="block h-4/5 max-h-100 w-auto max-w-4/5 object-contain drop-shadow-[0_0_28px_rgba(255,255,255,0.14)]"

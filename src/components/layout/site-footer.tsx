...
export function SiteFooter() {
  return (
    <footer className="mx-auto items-center gap-4 border-t border-white/[0.14] py-8 text-center text-[0.85rem] text-muted min-[621px]:grid-cols-[auto_1fr] min-[901px]:grid-cols-[1fr_auto_1fr]">
      <div className="mx-auto grid w-[calc(100%-2rem)] max-w-295 grid-cols-1 items-center gap-4 text-center text-[0.85rem] text-muted min-[621px]:grid-cols-[auto_1fr] min-[901px]:grid-cols-[1fr_auto_1fr]">
        <Logo compact />
